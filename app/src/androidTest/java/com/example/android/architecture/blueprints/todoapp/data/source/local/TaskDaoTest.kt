...
class TaskDaoTest {
    ...
    fun updateTaskAndGetById() = runBlockingTest {
        ...
        val originalTask = Task("DDT", "Testing")
        ...
        val updatedTask = Task("TDD", "Android Testing", true, originalTask.id)
        ...
        assertThat(loaded?.title, `is`("TDD"))
        assertThat(loaded?.description, `is`("Android Testing"))
